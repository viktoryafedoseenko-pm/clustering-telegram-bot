...
def clusterize_texts(file_path: str, progress_callback=None):
    ...
    def normalize_cluster_name(name: str) -> str:
        ...
        replacements = {
            ...
            'оплата курсов': 'оплата',
            'дипломы': 'диплом',
            'сертификаты': 'диплом',
            'получение диплома': 'диплом',
            'оформление диплома': 'диплом',
            'диплом и анкеты': 'диплом',
            'диплом и документы': 'диплом',
            'дипломы и документы': 'диплом',
            'дипломы и анкеты': 'диплом',
            'документы и анкеты': 'документы',
            'документы и дипломы': 'документы',
            'технические проблемы': 'технические ошибки',
            'технические вопросы': 'технические ошибки',
            'технические сбои': 'технические ошибки',
            'непонятные запросы': 'неясные запросы',
            'неясные запросы': 'неясные запросы',
            'управление подпиской': 'подписка',
            'управление платежами': 'платежи',
        }
