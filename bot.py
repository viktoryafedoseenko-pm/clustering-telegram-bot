...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_msg = """
👋 <b>Привет! Я бот для анализа текстов.</b>

Выбери режим работы:

🔍 <b>Кластеризация</b> (автоматическая)
• Я сам найду темы в твоих текстах
• Не нужно задавать категории заранее
• Подходит для исследования данных

🏷️ <b>Классификация</b> (по категориям)
• Ты задаёшь категории
• Я распределяю тексты по ним
• Подходит когда категории уже известны

📝 <b>Что я умею:</b>
• Анализирую до 50,000 текстов
• Нахожу скрытые паттерны
• Создаю детальные отчёты
• Работаю с русским и английским
...
/feedback - обратная связь
    ...
    # Создаем клавиатуру
    keyboard = [
        [InlineKeyboardButton("🔍 Кластеризация", callback_data="mode_clustering")]
    ]
