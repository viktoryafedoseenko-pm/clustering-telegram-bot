...
async def handle_file(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        try:
            ...
            file_info += "🔄 <b>Начинаю анализ. Файл в 5000 строк обрабатывается до 5 минут. На файл в 30000 строк может уйти до 30 минут. Можете закрыть чат – я пришлю сообщение, когда всё будет готово.</b>"
